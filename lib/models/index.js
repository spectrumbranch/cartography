...
module.exports.init = function(virt_modules, done) {
    ...
    (function(model) {
		...
		//internals scurvy associations
		//TODO: Consolidate into scurvy setup associations function
		var scurvy = require('scurvy');
		scurvy.setupAssociationsSync(model);
		...
		//TODO: Consolidate scurvy sync() calls into single async function with callback
